            ...
            <div class="row">
                <div class="col-12">
                    <ul class="page-breadcrumb__menu">
                        ...
                        <li class="page-breadcrumb__nav active">Blog Single Left Sidebar Page</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row flex-column-reverse flex-lg-row">
                ...
                <div class="col-lg-9">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="blog__type-single">
                                    <div class="img-responsive"><img src="assets/img/blog/single/blog-1.jpg" alt=""></div>
                                    <div class="blog__content">
                                        <h3 class="title title--small title--thin">This is Third Post For XipBlog</h3>
                    ...
                    <!-- Start Blog Comment -->
                    <div class="blog blog--comment blog--1">
                    ...
                    <div class="blog blog--comment-form">
                        <div class="section-content">
